...
use entropyx_consensus::consensus::Consensus;
use entropyx_consensus::model::stores::virtual_state::VirtualStateStoreReader;
use entropyx_consensus::params::Params;
use entropyx_consensus_core::api::ConsensusApi;
use entropyx_consensus_core::block::{Block, TemplateBuildMode, TemplateTransactionSelector};
use entropyx_consensus_core::coinbase::MinerData;
use entropyx_consensus_core::mass::{Kip9Version, MassCalculator};
...
use entropyx_consensus_core::utxo::utxo_view::UtxoView;
use entropyx_core::trace;
use entropyx_utils::sim::{Environment, Process, Resumption, Suspension};
...
impl TemplateTransactionSelector for OnetimeTxSelector {
    ...
    fn reject_selection(&mut self, _tx_id: entropyx_consensus_core::tx::TransactionId) {
        unimplemented!()
    }
