...
use entropyx_consensus::config::Config;
...
use entropyx_database::{create_permanent_db, create_temp_db};
use entropyx_utils::fd_budget;
use entropyx_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct EntropyXNetworkSimulator {
