...
use entropyx_wasm_core::hex::{HexViewConfig, HexViewConfigT};
use entropyx_wasm_core::types::{BinaryT, HexString};
...
impl ScriptBuilder {
    ...
    /// and any push of data greater than [`MAX_SCRIPT_ELEMENT_SIZE`](entropyx_txscript::MAX_SCRIPT_ELEMENT_SIZE) will not modify
    ...
    /// exceed the maximum allowed script engine size [`MAX_SCRIPTS_SIZE`](entropyx_txscript::MAX_SCRIPTS_SIZE).
