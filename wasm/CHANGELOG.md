Latest online documentation available at: https://entropyx.aspectron.org/docs/
...
- Merge with Rusty EntropyX master (0.13.6)
...
- Rename `entropyx-beacon` app to `entropyx-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `entropyx-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://entropyx.aspectron.org/docs/
