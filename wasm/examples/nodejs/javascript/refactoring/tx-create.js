...
const entropyx = require('../entropyx/entropyx_wasm');
...
entropyx.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"entropyx:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "entropyxtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("entropyxtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new entropyx.TransactionOutput(300n, new entropyx.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new entropyx.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
