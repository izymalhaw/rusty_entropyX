let entropyx = require('../../../../nodejs/entropyx');
let {
    PrivateKey,
    PublicKey,
    PublicKeyGenerator,
...
// Getting EntropyX Address from Private Key
...
function demoGenerateAddressFromPublicKeyHexString() {
    ...
    console.info(publicKey.toAddress(NetworkType.Mainnet).toString() == 'entropyx:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(xOnlyPublicKey.toAddress(NetworkType.Mainnet).toString() == 'entropyx:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(fullDERPublicKey.toAddress(NetworkType.Mainnet).toString() == 'entropyx:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq');
}