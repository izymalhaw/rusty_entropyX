...
(async () => {
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the EntropyX
        ...
        let generator = new Generator({
            entries,
            outputs: [{address, amount : entropyxToSompi(0.2)}],
            // priorityFee: 1000n,
            priorityFee: entropyxToSompi(0.0001),
            changeAddress: sourceAddress,
        });

        // transaction generator creates a 
        // sequence of transactions
        // for a requested amount of ENX.
