...
use entropyx_utils::{hex::ToHex, serde_bytes_fixed_ref};
use serde::{Deserialize, Serialize};
use workflow_serializer::prelude::*;

use crate::prelude::{RpcHash, RpcScriptClass, RpcSubnetworkId};

/// Represents the ID of a EntropyX transaction
...
/// Represents a EntropyX transaction outpoint
...
impl From<entropyx_consensus_client::TransactionOutpoint> for RpcTransactionOutpoint {
    fn from(outpoint: entropyx_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl From<RpcTransactionOutpoint> for entropyx_consensus_client::TransactionOutpoint {
    fn from(outpoint: RpcTransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}
...
/// Represents a EntropyX transaction input
...
/// Represent EntropyX transaction input verbose data
...
/// Represents a EntropyX transaction output
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent EntropyX transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represents a EntropyX transaction
#[derive(Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent EntropyX transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
