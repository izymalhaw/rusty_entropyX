...
use entropyx_consensus_notify::notification as consensus_notify;
use entropyx_index_core::notification as index_notify;
use std::sync::Arc;
...
impl From<&index_notify::UtxosChangedNotification> for UtxosChangedNotification {
    ...
    // Use entropyx_rpc_service::converter::index::IndexConverter instead.
