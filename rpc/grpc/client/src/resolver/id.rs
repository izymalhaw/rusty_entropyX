use crate::{
    error::{Error, Result},
    resolver::{EntropyXResponseReceiver, EntropyXResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: EntropyXResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: EntropyXPayloadOps, request: &EntropyXRequest) -> EntropyXResponseReceiver {
