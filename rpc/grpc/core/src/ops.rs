use crate::protowire::{entropy_x_request::Payload as RequestPayload, entropy_x_response::Payload as ResponsePayload, *};
...
pub enum EntropyXPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into EntropyXPayloadOps fails.
