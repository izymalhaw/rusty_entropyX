...
use entropyx_rpc_core::RpcError;

// ----------------------------------------------------------------------------
// rpc_core to protowire
// ----------------------------------------------------------------------------

from!(item: &entropyx_rpc_core::ConnectionsProfileData, protowire::ConnectionsProfileData, {
    Self {
...
from!(item: &entropyx_rpc_core::ProcessMetrics, protowire::ProcessMetrics, {
    Self {
...
from!(item: &entropyx_rpc_core::ConnectionMetrics, protowire::ConnectionMetrics, {
    Self {
...
from!(item: &entropyx_rpc_core::BandwidthMetrics, protowire::BandwidthMetrics, {
    Self {
...
from!(item: &entropyx_rpc_core::ConsensusMetrics, protowire::ConsensusMetrics, {
    Self {
...
from!(item: &entropyx_rpc_core::StorageMetrics, protowire::StorageMetrics, {
    Self {
...
try_from!(item: &protowire::ConnectionsProfileData, entropyx_rpc_core::ConnectionsProfileData, {
    Self { cpu_usage : item.cpu_usage as f32, memory_usage : item.memory_usage }
});

try_from!(item: &protowire::ProcessMetrics, entropyx_rpc_core::ProcessMetrics, {
    Self {
        resident_set_size: item.resident_set_size,
        virtual_memory_size: item.virtual_memory_size,
        core_num: item.core_num,
...
try_from!(item: &protowire::ConnectionMetrics, entropyx_rpc_core::ConnectionMetrics, {
    Self {
        borsh_live_connections: item.borsh_live_connections,
        borsh_connection_attempts: item.borsh_connection_attempts,
        borsh_handshake_failures: item.borsh_handshake_failures,
...
try_from!(item: &protowire::BandwidthMetrics, entropyx_rpc_core::BandwidthMetrics, {
    Self {
        borsh_bytes_tx: item.borsh_bytes_tx,
        borsh_bytes_rx: item.borsh_bytes_rx,
        json_bytes_tx: item.json_bytes_tx,
...
try_from!(item: &protowire::ConsensusMetrics, entropyx_rpc_core::ConsensusMetrics, {
    Self {
...
try_from!(item: &protowire::StorageMetrics, entropyx_rpc_core::StorageMetrics, {
    Self {
        storage_size_bytes: item.storage_size_bytes,
    }
});
