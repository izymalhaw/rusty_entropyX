...
from!(item: &entropyx_rpc_core::RpcFeerateBucket, protowire::RpcFeerateBucket, {
    Self {
...
from!(item: &entropyx_rpc_core::RpcFeeEstimate, protowire::RpcFeeEstimate, {
    Self {
...
from!(item: &entropyx_rpc_core::RpcFeeEstimateVerboseExperimentalData, protowire::RpcFeeEstimateVerboseExperimentalData, {
    Self {
...
try_from!(item: &protowire::RpcFeerateBucket, entropyx_rpc_core::RpcFeerateBucket, {
    Self {
        feerate: item.feerate,
        estimated_seconds: item.estimated_seconds,
    }
...
try_from!(item: &protowire::RpcFeeEstimate, entropyx_rpc_core::RpcFeeEstimate, {
    Self {
...
try_from!(item: &protowire::RpcFeeEstimateVerboseExperimentalData, entropyx_rpc_core::RpcFeeEstimateVerboseExperimentalData, {
    Self {
        network_mass_per_second: item.network_mass_per_second,
        mempool_ready_transactions_count: item.mempool_ready_transactions_count,
        mempool_ready_transactions_total_mass: item.mempool_ready_transactions_total_mass,
