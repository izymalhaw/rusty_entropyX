...
use crate::imports::*;
use js_sys::Array;
pub use entropyx_rpc_macros::declare_typescript_wasm_interface as declare;
use entropyx_wrpc_client::node::NodeDescriptor;
use entropyx_wrpc_client::Resolver as NativeResolver;
use serde::ser;
...
///
/// Resolver is a client for obtaining public EntropyX wRPC URL.
///
/// Resolver queries a list of public EntropyX Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public EntropyX Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public EntropyX wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public EntropyX wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public EntropyX wRPC endpoint for the given encoding and network identifier
