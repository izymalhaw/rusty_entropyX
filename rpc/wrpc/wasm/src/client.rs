...
use entropyx_addresses::{Address, AddressOrStringArrayT};
use entropyx_consensus_client::UtxoEntryReference;
use entropyx_consensus_core::network::{NetworkType, NetworkTypeT};
use entropyx_notify::connection::ChannelType;
use entropyx_notify::events::EventType;
use entropyx_notify::listener;
use entropyx_notify::notification::Notification as NotificationT;
use entropyx_rpc_core::api::ctl;
pub use entropyx_rpc_core::wasm::message::*;
pub use entropyx_rpc_macros::{
    build_wrpc_wasm_bindgen_interface, build_wrpc_wasm_bindgen_subscriptions, declare_typescript_wasm_interface as declare,
};
use entropyx_wasm_core::events::{get_event_targets, Sink};
...
pub struct Inner {
    ...
    notification_channel: Channel<entropyx_rpc_core::Notification>,
}
...
///
///
/// EntropyX RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with EntropyX Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any EntropyX Node or to a
...
/// ```
///
/// **Connecting to a EntropyX Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for EntropyX node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            EntropyXRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the EntropyX RPC server. This function starts a background
    ...
    /// Disconnect from the EntropyX RPC server.
    ...
    /// however, you have to re-subscribe for EntropyX node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<EntropyXRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<EntropyXRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                entropyx_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = EntropyXRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the EntropyX BlockDAG.
    ...
    /// EntropyX BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the EntropyX BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the EntropyX BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the EntropyX BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the EntropyX BlockDAG is resolved.
    ...
    /// score of the sink block changes in the EntropyX BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the EntropyX BlockDAG.
    ...
    /// template is generated for mining in the EntropyX BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the EntropyX BlockDAG.
        ...
        /// structure of the EntropyX BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of EntropyX network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the EntropyX node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the EntropyX node.
        /// Returned information: Version of the EntropyX node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the EntropyX
        ...
        /// performance and status of the EntropyX node.
        ...
        /// the highest cumulative difficulty in the EntropyX BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a EntropyX node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the EntropyX node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the EntropyX server.
        /// Returned information: Version of the EntropyX server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the EntropyX node.
        /// Returned information: Syncing status.
        GetSyncStatus,
        // ENX-CHANGE-BURN:
        /// Retrieves the total amount of burned coins in the EntropyX network.
        /// Returned information: Total burned amount.
        GetTotalBurnedAmount,
        /// Retrieves a range of burn records from the EntropyX network.
        /// Returned information: List of burn records.
        GetBurnRecordsByRange,
        /// Retrieves burn record information by utxo ID.
        /// Returned information: Burn record information.
        GetBurnRecordByUtxoId,
        /// Retrieves the current burn fee in the EntropyX network.
        /// Returned information: Current burn fee.
        GetCurrentBurnFee,
    ],
    [
        // functions with `request` argument
        /// Adds a peer to the EntropyX node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the EntropyX node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the EntropyX BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the EntropyX BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the EntropyX BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the EntropyX BlockDAG.
        ...
        GetCurrentNetwork,
        /// Retrieves block headers from the EntropyX BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the EntropyX node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the EntropyX BlockDAG.
        ...
        /// Resolves a finality conflict in the EntropyX BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the EntropyX network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the EntropyX network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the EntropyX network.
