        ...
        for handler in self.handlers.elems.iter() {
            ...
            targets.push(quote! {
                ...
                fn #fn_call<'life0, 'life1, 'async_trait>(
                    &'life0 self,
                    _connection : ::core::option::Option<&'life1 Arc<dyn entropyx_rpc_core::api::connection::RpcConnection>>,
                    ...
                    Self: 'async_trait,
                {
                    ...
                    Box::pin(async move {
                        ...
                        let __ret: RpcResult<Serializable<#response_type>> = {
                            ...
                            Ok(resp.map_err(|e| entropyx_rpc_core::error::RpcError::RpcSubsystem(e.to_string()))?)
                        };
