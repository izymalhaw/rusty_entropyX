...
use entropyx_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use entropyx_consensusmanager::{ConsensusManager, ConsensusProxy};
use entropyx_math::Uint256;
use entropyx_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use entropyx_notify::converter::Converter;
...
use entropyx_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-ENTROPYX: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-ENTROPYX: PopulateTransactionWithVerboseData
