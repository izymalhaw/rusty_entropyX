...
use entropyx_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use entropyx_rpc_core::notify::mode::NotificationMode;
use entropyx_rpc_service::service::RpcCoreService;
use entropyx_utils::triggers::Listener;
use entropyx_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use entropyx_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_entropyx_tempdir();
