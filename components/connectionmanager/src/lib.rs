...
use entropyx_addressmanager::{AddressManager, NetAddress};
use entropyx_core::{debug, info, warn};
use entropyx_p2p_lib::{common::ProtocolError, ConnectionError, Peer};
...
pub struct ConnectionManager {
    p2p_adaptor: Arc<entropyx_p2p_lib::Adaptor>,
...
impl ConnectionManager {
    ...
    async fn handle_outbound_connections(self: &Arc<Self>, peer_by_address: &HashMap<SocketAddr, Peer>) {
        let active_outbound: HashSet<entropyx_addressmanager::NetAddress> =
