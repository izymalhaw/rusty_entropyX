...
///     }
/// }
/// impl entropyx_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// entropyx_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// entropyx_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "entropyx_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
