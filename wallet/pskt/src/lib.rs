//!
//! PSKT is a crate for working with Partially Signed EntropyX Transactions (PSKTs).
...
//! multiple `PSKT` instances allowing for exchange of EntropyX sweep transactions.
//!
