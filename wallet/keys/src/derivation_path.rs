...
pub struct DerivationPath {
    inner: entropyx_bip32::DerivationPath,
}
...
impl DerivationPath {
    ...
    pub fn new(path: &str) -> Result<DerivationPath> {
        let inner = entropyx_bip32::DerivationPath::from_str(path)?;
        Ok(Self { inner })
    }
...
impl<'a> From<&'a DerivationPath> for &'a entropyx_bip32::DerivationPath {
