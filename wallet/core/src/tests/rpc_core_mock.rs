...
use entropyx_notify::events::EVENT_TYPE_ARRAY;
use entropyx_notify::listener::{ListenerId, ListenerLifespan};
use entropyx_notify::notifier::{Notifier, Notify};
use entropyx_notify::scope::Scope;
...
use entropyx_rpc_core::api::ctl::RpcCtl;
use entropyx_rpc_core::{api::connection::DynRpcConnection, api::rpc::RpcApi, *};
use entropyx_rpc_core::{notify::connection::ChannelConnection, RpcResult};
use std::sync::Arc;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub fn notify_new_block_template(&self) -> entropyx_notify::error::Result<()> {
