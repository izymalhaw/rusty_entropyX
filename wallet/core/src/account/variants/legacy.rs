//!
//! Legacy (KDX, entropyxnet.io Web Wallet) account implementation
//!

use crate::account::{AsLegacyAccount, Inner};
use crate::derivation::{AddressDerivationManager, AddressDerivationManagerTrait};
use crate::imports::*;
use entropyx_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "entropyx-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "EntropyX Legacy Account (KDX, entropyxnet.io Web Wallet)".to_string()
    }
