...
interface IGeneratorSettingsObject {
     ...
     * 
     * Typical usage: { address: "entropyx:...", amount: 1000n }
     */
...
///     utxoEntries : [...],
///     changeAddress : "entropyx:...",
///     outputs : [
///         { amount : entropyxToSompi(10.0), address: "entropyx:..."},
///         { amount : entropyxToSompi(20.0), address: "entropyx:..."},
///         ...
///     ],
///     priorityFee : 1000n,
/// });
