...
use entropyx_wallet_macros::declare_typescript_wasm_interface as declare;
use entropyx_wasm_core::events::{get_event_targets, Sink};
use entropyx_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty EntropyX is developed in Rust, and the Wallet class is a Rust implementation
