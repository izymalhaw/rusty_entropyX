...
use js_sys::Array;
use entropyx_consensus_client::{sign_with_multiple_v3, Transaction};
use entropyx_consensus_core::hashing::wasm::SighashType;
use entropyx_consensus_core::sign::sign_input;
use entropyx_consensus_core::tx::PopulatedTransaction;
use entropyx_consensus_core::{hashing::sighash_type::SIG_HASH_ALL, sign::verify};
use entropyx_hashes::Hash;
use entropyx_wallet_keys::privatekey::PrivateKey;
use entropyx_wasm_core::types::HexString;
