...
pub(crate) async fn create(
    ...
    if let Err(err) = wallet.network_id() {
        tprintln!(ctx);
        tprintln!(ctx, "Before creating a wallet, you need to select a EntropyX network.");
    ...
    if !import_with_mnemonic {
        ...
        tpara!(
            ...
            the EntropyX stored in it. Keep your mnemonic safe. Write it down and \
