...
use entropyx_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] entropyx_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] entropyx_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] entropyx_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] entropyx_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(entropyx_metrics_core::error::Error),

    #[error(transparent)]
    EntropyXWalletKeys(#[from] entropyx_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] entropyx_wallet_pskt::error::Error),
