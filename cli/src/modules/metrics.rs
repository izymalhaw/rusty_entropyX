use crate::imports::*;
use entropyx_metrics_core::{Metrics as MetricsProcessor, MetricsSinkFn};
...
impl Metrics {
    ...
    pub async fn display_help(self: &Arc<Self>, ctx: Arc<EntropyXCli>, _argv: Vec<String>) -> Result<()> {
