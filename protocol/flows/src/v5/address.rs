...
use entropyx_addressmanager::NetAddress;
use entropyx_p2p_lib::{
    common::ProtocolError,
    dequeue, dequeue_with_timeout, make_message,
    pb::{entropy_x_message::Payload, AddressesMessage, RequestAddressesMessage},
...
/// The maximum number of addresses that are sent in a single entropyx Addresses message.
const MAX_ADDRESSES_SEND: usize = 1000;

/// The maximum number of addresses that can be received in a single entropyx Addresses response.
