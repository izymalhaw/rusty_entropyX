...
//! since the syncee no longer uses them in the rusty-entropyx design where the full sub-DAG is sent
//!
...
use entropyx_p2p_lib::{
    ...
    pb::{
        self, entropy_x_message::Payload, BlockWithTrustedDataV4Message, DoneBlocksWithTrustedDataMessage, PruningPointsMessage,
        TrustedDataMessage,
    },
