...
use entropyx_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    entropyx_core::log::init_logger(None, "debug");
    ...
    let adaptor = entropyx_p2p_lib::Adaptor::bidirectional(ip_port, entropyx_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
