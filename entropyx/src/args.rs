...
use entropyx_core::entropyx_env::version;
use entropyx_notify::address::tracker::Tracker;
use entropyx_utils::networking::ContextualNetAddress;
use entropyx_wrpc_server::address::WrpcNetAddress;
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> entropyx_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("entropyx")
        .about(format!("{} (rusty-entropyx) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
...
/*
  ...
  -C, --configfile=                         Path to configuration file (default: /Users/aspect/Library/Application
                                            Support/EntropyX/entropyx.conf)
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/EntropyX/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/EntropyX/rpc.key)
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in ENX/kB to be considered a non-zero fee.
                                            (default: 1e-05)
