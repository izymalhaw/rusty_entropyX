...
use js_sys::BigInt;
use entropyx_consensus_client::Header;
use entropyx_consensus_client::HeaderT;
use entropyx_consensus_core::hashing;
use entropyx_hashes::Hash;
use entropyx_hashes::PowHash;
use entropyx_math::Uint256;
use entropyx_utils::hex::FromHex;
...
/// Represents a EntropyX header PoW manager
/// @category Mining
...
// https://github.com/tmrlvi/entropyx-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L36
...
/// <https://github.com/tmrlvi/entropyx-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category Mining
