use entropyx_consensus_core::acceptance_data::AcceptanceData;
use entropyx_consensus_core::acceptance_data::AcceptedTxEntry;
use entropyx_consensus_core::acceptance_data::MergesetBlockAcceptanceData;
