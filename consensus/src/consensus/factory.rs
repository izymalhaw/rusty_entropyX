...
use entropyx_consensusmanager::{ConsensusFactory, ConsensusInstance, DynConsensusCtl, SessionLock};
use entropyx_core::{debug, time::unix_now, warn};
use entropyx_database::{
    prelude::{
...
impl ConsensusFactory for Factory {
    fn new_active_consensus(&self) -> (ConsensusInstance, DynConsensusCtl) {
        ...
        let db = entropyx_database::prelude::ConnBuilder::default()
            .with_db_path(dir)
