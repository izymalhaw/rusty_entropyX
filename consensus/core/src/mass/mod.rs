...
// `entropyx_wallet_core::tx::mass::MassCalculator`
#[derive(Clone)]
...
mod tests {
    use super::*;
    use crate::{
        constants::{SOMPI_PER_ENX, STORAGE_MASS_PARAMETER},
    ...
    fn test_mass_storage() {
        ...
        let base_value = 10_000 * SOMPI_PER_ENX;
        ...
        tx2.tx.outputs[0].value = 10 * SOMPI_PER_ENX;
        let storage_mass =
