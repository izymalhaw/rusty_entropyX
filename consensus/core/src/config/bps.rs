...
impl<const BPS: u64> Bps<BPS> {
    ...
    /// ENX-CHANGE: Block reward halving period
    /// 
    /// Parameters:
    /// - BPS: Blocks per second
    /// 
    /// Returns:
    /// - u64: Block reward halving period (in seconds)
    pub const fn deflationary_phase_daa_score() -> u64 {
        // 10 minutes halving period
        // BPS * 600

        // 30 minutes halving period
        // BPS * 1800

        // 1 hour halving period
        // BPS * 600 * 6

        // Number of seconds in a year = 365.25 * 24 * 60 * 60 = 31557600
        BPS * 31557600
        // BPS * (15778800 - 259200)
    }

    /// ENX-CHANGE: Pre-halving period base subsidy
    /// 
    /// Parameters:
    /// - BPS: Blocks per second
    /// 
    /// Returns:
    /// - u64: Pre-halving period base subsidy
    pub const fn pre_deflationary_phase_base_subsidy() -> u64 {
        33300000000 / BPS
    }
