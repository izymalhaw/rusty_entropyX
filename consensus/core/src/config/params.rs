...
use crate::{
    ...
    BlockLevel, KType,
    burn::BurnFeeCalculator, // ENX-CHANGE-BURN:
};
...
pub struct Params {
    ...
    /// The parameter for scaling inverse ENX value to mass units (unpublished KIP-0009)
    ...
    pub burn_fee_calculator: BurnFeeCalculator,
}
...
impl Params {
    ...
    /// Based on the analysis at <https://github.com/entropyxnet/docs/blob/main/Reference/prunality/Prunality.pdf>
...
pub const MAINNET_PARAMS: Params = Params {
    dns_seeders: &[
        ...
        "seeder.entropyx.org",
        // This DNS seeder
        "seeder1-mainnet.entropyx.org",
        // This DNS seeder
        "seeder2-mainnet.entropyx.org",
    ],
    ...
    // This is technically a soft fork from the Go implementation since entropyx's consensus doesn't
    ...
    deflationary_phase_daa_score: 31557600, // ENX-CHANGE: 60 * 60 * 24 * 365.25,
    pre_deflationary_phase_base_subsidy: 33300000000, // ENX-CHANGE: Original value was 50000000000 sompi
    coinbase_maturity: 100,
    skip_proof_of_work: false,
    max_block_level: 225,
    pruning_proof_m: 1000,
    burn_fee_calculator: BurnFeeCalculator { initial_burn_fee: 21000000000, deflationary_phase_daa_score: 31557600 }, // ENX-CHANGE-BURN:
};

pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        // This testnet DNS seeder
        "seeder1-testnet.entropyx.org",
    ],
    ...
    // deflationary_phase_daa_score: 15778800 - 259200,
    // pre_deflationary_phase_base_subsidy: 50000000000,
    deflationary_phase_daa_score: 31557600, // ENX-CHANGE: Original value was  15778800 - 259200,
    pre_deflationary_phase_base_subsidy: 33300000000, // ENX-CHANGE: Original value was 50000000000 sompi
    coinbase_maturity: 100,
    skip_proof_of_work: false,
    max_block_level: 250,
...
pub const TESTNET11_PARAMS: Params = Params {
    dns_seeders: &[
        // This testnet-11 DNS seeder
        "seeder1-testnet-11.entropyx.org",
    ],
...
pub const DEVNET_PARAMS: Params = Params {
    ...
    // The network was down for three days shortly after launch
    // Three days in seconds = 3 * 24 * 60 * 60 = 259200
    deflationary_phase_daa_score: 600, // ENX-CHANGE: Original value was  15778800 - 259200,
    pre_deflationary_phase_base_subsidy: 333 * 365 * 24 * 100000000, // ENX-CHANGE: Original value was 50000000000 sompi
    coinbase_maturity: 100,
    skip_proof_of_work: false,
    max_block_level: 250,
    pruning_proof_m: 1000,
    burn_fee_calculator: BurnFeeCalculator { initial_burn_fee: 21000000000, deflationary_phase_daa_score: 600 }, // ENX-CHANGE-BURN:
};
