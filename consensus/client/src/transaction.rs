...
use entropyx_consensus_core::network::NetworkTypeT;
use entropyx_consensus_core::subnets::{self, SubnetworkId};
use entropyx_consensus_core::tx::UtxoEntry;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<entropyx_addresses::AddressArrayT> {
