use entropyx_consensus_core::constants::TX_VERSION;
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`entropyx_consensus_core::config::params::Params`] instance.
