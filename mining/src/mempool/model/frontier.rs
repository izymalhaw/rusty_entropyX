...
use entropyx_consensus_core::{block::TemplateTransactionSelector, tx::Transaction};
...
impl Frontier {
    ...
    ///           from `~1/50` (2000 sompi for a transaction with 100K storage mass), to `5M` (100 ENX fee for a transaction with
    ...
    pub fn test_highly_irregular_sampling() {
        ...
        for i in 0..cap as u64 {
            ...
            if i == 0 {
                ...
                fee = 100_000_000 * 1_000_000; // 1M ENX
            }
            let mass: u64 = 1650;
